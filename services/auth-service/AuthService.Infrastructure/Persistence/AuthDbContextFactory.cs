...
namespace AuthService.Infrastructure.Persistence
{
    ...
    public class AuthDbContextFactory : IDesignTimeDbContextFactory<AuthDbContext>
    {
        ...
        private static string BuildConnectionString()
        {
            ...
            var database = Environment.GetEnvironmentVariable("AUTH_DB_NAME")
                ...
                string.IsNullOrWhiteSpace(database) || string.IsNullOrWhiteSpace(username) || string.IsNullOrWhiteSpace(password))
            {
                throw new InvalidOperationException(
                    "Database configuration is missing. Set ConnectionStrings__DefaultConnection or DB_HOST/DB_PORT/AUTH_DB_NAME/DB_USER/DB_PASSWORD.");
            }
