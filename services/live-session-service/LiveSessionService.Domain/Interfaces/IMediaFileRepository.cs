...
public interface IMediaFileRepository
{
    ...
    Task<MediaFile?> GetByAzuraCastMediaIdAsync(string azuraCastMediaId, CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<MediaFile>> GetByAzuraCastMediaIdsAsync(IReadOnlyCollection<string> azuraCastMediaIds, CancellationToken cancellationToken = default);
