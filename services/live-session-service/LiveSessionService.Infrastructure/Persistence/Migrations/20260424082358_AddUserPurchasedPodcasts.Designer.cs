...
namespace LiveSessionService.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260424082358_AddUserPurchasedPodcasts")]
    partial class AddUserPurchasedPodcasts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LiveSessionService.Domain.Entities.LiveSessionChat", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("live_session_chats", (string)null);
                });
            ...
            modelBuilder.Entity("LiveSessionService.Domain.Entities.PodcastEpisode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("PodcastId", "EpisodeNumber")
                        .IsUnique();
            ...
            modelBuilder.Entity("LiveSessionService.Domain.Entities.SongRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("LiveSessionService.Domain.Entities.StationMediaFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MediaFileId", "StationId")
                        .IsUnique();

                    b.ToTable("station_media_files", (string)null);
                });
            ...
            modelBuilder.Entity("LiveSessionService.Domain.Entities.StationPlaylist", b =>
                {
                    ...
                    b.Property<int>("SongPlaybackOrder")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LiveSessionService.Domain.Entities.SyncAuditLog", b =>
                {
                    ...
                    b.ToTable("sync_audit_logs", (string)null);
                });
            ...
            modelBuilder.Entity("LiveSessionService.Domain.Entities.UserPlaylist", b =>
                {
                    ...
                    b.HasIndex("UserId", "PlaylistOrder");

                    b.ToTable("user_playlists", (string)null);
                });

            modelBuilder.Entity("LiveSessionService.Domain.Entities.UserPlaylistMedia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("user_playlist_medias", (string)null);
                });

            modelBuilder.Entity("LiveSessionService.Domain.Entities.UserPurchasedPodcast", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("UserPurchasedPodcasts", (string)null);
                });

            modelBuilder.Entity("LiveSessionService.Domain.Entities.UserSavedPodcast", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("user_saved_podcasts", (string)null);
                });
            ...
            modelBuilder.Entity("LiveSessionService.Domain.Entities.PodcastEpisode", b =>
                {
                    b.HasOne("LiveSessionService.Domain.Entities.Podcast", "Podcast")
                        .WithMany("Episodes")
            ...
            modelBuilder.Entity("LiveSessionService.Domain.Entities.StationMediaFile", b =>
                {
                    b.HasOne("LiveSessionService.Domain.Entities.MediaFile", "MediaFile")
                        .WithMany("StationMediaFiles")
                        .HasForeignKey("MediaFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LiveSessionService.Domain.Entities.AzuraCastStation", "Station")
                        .WithMany("StationMediaFiles")
            ...
            modelBuilder.Entity("LiveSessionService.Domain.Entities.UserPlaylistMedia", b =>
                {
                    b.HasOne("LiveSessionService.Domain.Entities.MediaFile", "MediaFile")
                        .WithMany("UserPlaylistMedias")
                        .HasForeignKey("MediaFileId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("LiveSessionService.Domain.Entities.UserPlaylist", "UserPlaylist")
                        .WithMany("UserPlaylistMedias")
            ...
            modelBuilder.Entity("LiveSessionService.Domain.Entities.AzuraCastStation", b =>
                {
                    ...
                    b.Navigation("StationMediaFiles");
                });
            ...
            modelBuilder.Entity("LiveSessionService.Domain.Entities.MediaFile", b =>
                {
                    ...
                    b.Navigation("UserPlaylistMedias");
                });
            ...
            modelBuilder.Entity("LiveSessionService.Domain.Entities.Podcast", b =>
                {
                    ...
                    b.Navigation("UserSavedPodcasts");
                });
