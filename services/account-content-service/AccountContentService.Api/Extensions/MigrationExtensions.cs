...
public static class MigrationExtensions
{
    public static async Task ApplyMigrationsAsync(this WebApplication app)
    {
        ...
        // Ensure account_content_db exists before migration
        await EnsureDatabaseExistsAsync("account_content_db", logger);
    ...
    public static async Task SeedDataAsync(this WebApplication app)
    {
        ...
        {
            logger.LogError(ex, "Error during data seeding. Application will continue.");
        }
    }
